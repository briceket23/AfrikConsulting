...
export default function SwiftGo({isImageFirst}: {
    isImageFirst: boolean,
}) {
  return (
                <div id='swift-go' className="my-20 flex flex-col md:flex-row justify-center items-center text-center md:text-left">
                            {isImageFirst &&
                <div
